...
module.exports.sendResetEmail = async (email, token) => {
  ...
  await smtpTransport.sendMail({
    from: fromsendemail,
    to: email,
    subject: "MERESET PASSWORD AKUN ANDA",
    html: `
    <!DOCTYPE html>
    <html>
    <head>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                  <p style="margin: 0;">
                    Masalah Login?<br>reset password anda.<br><br>Hanya tekan buttton di bawah dan ikut arahan. Kami akan membantu anda beroperasi dalam masa yang singkat.</p>
                </td>
              </tr>
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px; border-bottom: 3px solid #d4dadf">
                  <p style="margin: 0;">Ryasya,<br> ${domain}</p>
                </td>
              </tr>
...
module.exports.sendVerifyEmail = async (email, token) => {
  ...
  await smtpTransport.sendMail({
    ...
    <body style="background-color: #e9ecef;">
      ...
      <div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
        Verify Email Anda Dengan klik Buton Di Bawah.
      </div>
        ...
        <tr>
          <td align="center" bgcolor="#e9ecef">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                  <p style="margin: 0;">Terima kasih karena menggunakan rest api ryasya, Silahkan tekan button di bawah untuk verify akun anda.</p>
                </td>
              </tr>
        ...
        <tr>
          <td align="center" bgcolor="#e9ecef" style="padding: 24px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
              ...
              <tr>
                <td align="center" bgcolor="#e9ecef" style="padding: 12px 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 14px; line-height: 20px; color: #666;">
                  <p style="margin: 0;">Anda menerima email ini karena kami menerima permintaan untuk verify akun untuk akun anda.</p>
                </td>
              </tr>
